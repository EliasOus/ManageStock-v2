/*
  ...
  - Added the required column `motif` to the `Retour` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE "Retour" ADD COLUMN     "motif" TEXT NOT NULL,
ADD COLUMN     "numeroDeRetour" TEXT NOT NULL,
ADD COLUMN     "statut" TEXT NOT NULL DEFAULT 'En attente';
